...
At it's heart, JavaScript is third major component of the World Wide Web as we know it. The other two being HTML, which is a websites architecture and content, and CSS, which is the styles, fittings and furnishings of the website. JavaScript sits on top and provides a way of interacting with a user and webpage, adding anything dynamic on top. It was first released as part of Netscape (the original web browser) and was only named JavaScript to build on the cachet of 'Java' (the two have zero in common), and was described as 'digital glue'. From that, it has grown to be incredibly wide spread, heavily used and in my opinion very good fun!
